...
<body>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-primary m-0">
                            <i class="fas fa-users-cog me-2"></i>Data transaksi barang
                        </h6>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="transaksiDetailModalLabel">
                        <i class="fas fa-user-shield me-2"></i>Detail transaksi barang
                    </h5>
    ...
    <script src="controller/transaksiCartController.js"></script>
</body>
