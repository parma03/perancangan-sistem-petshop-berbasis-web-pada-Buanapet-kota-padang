...
<body>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-primary m-0">
                            <i class="fas fa-users-cog me-2"></i>Data histori transaksi booking services
                        </h6>
                    </div>

                    <div class="transaksi-data-container">
                        <div class="text-center py-3">
                            <div class="spinner-border text-primary" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                            <p class="mt-2">Memuat data histori transaksi booking services...</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="transaksiDetailModalLabel">
                        <i class="fas fa-user-shield me-2"></i>Detail histori transaksi
                    </h5>
                ...
                <div class="modal-body">
                    <div id="transaksiDetailContent">
                        <div class="text-center py-3">
                            ...
                            <p class="mt-2">Memuat detail histori transaksi booking services...</p>
                        </div>
                    </div>
                </div>
    ...
    <script src="controller/historiServicesController.js"></script>
</body>
