...
<body>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-primary m-0">
                            <i class="fas fa-users-cog me-2"></i>Data Pimpinan
                        </h6>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-success btn-sm add-pimpinan-btn">
                    ...
                    <div class="pimpinan-data-container">
    ...
    <!-- Modal Detail Pimpinan -->
    <div class="modal fade" id="pimpinanDetailModal" tabindex="-1" aria-labelledby="pimpinanDetailModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pimpinanDetailModalLabel">
                        <i class="fas fa-user-shield me-2"></i>Detail Pimpinan
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="pimpinanDetailContent">
                        <div class="text-center py-3">
                            <div class="spinner-border text-primary" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
    ...
    <!-- Modal Form Pimpinan (Tambah/Edit) - UPDATED DESIGN -->
    <div class="modal fade" id="pimpinanFormModal" tabindex="-1" aria-labelledby="pimpinanFormModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-gradient text-white"
                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <h5 class="modal-title" id="pimpinanFormModalLabel">
                        <i class="fas fa-user-plus me-2"></i>Tambah Pimpinan
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form id="pimpinanForm" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        <input type="hidden" id="pimpinan_id" name="pimpinan_id">
