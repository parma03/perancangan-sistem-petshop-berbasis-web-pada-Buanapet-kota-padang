...
<body>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-primary m-0">
                            <i class="fas fa-users-cog me-2"></i>Data Pelanggan
                        </h6>
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-success btn-sm add-pelanggan-btn">
                    ...
                    <div class="pelanggan-data-container">
    ...
    <div class="modal fade" id="pelangganDetailModal" tabindex="-1" aria-labelledby="pelangganDetailModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pelangganDetailModalLabel">
                        <i class="fas fa-user-shield me-2"></i>Detail Pelanggan
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div id="pelangganDetailContent">
                        <div class="text-center py-3">
                            <div class="spinner-border text-primary" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
    ...
    <!-- Modal Form Pelanggan (Tambah/Edit) - UPDATED DESIGN -->
    <div class="modal fade" id="pelangganFormModal" tabindex="-1" aria-labelledby="pelangganFormModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-gradient text-white"
                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <h5 class="modal-title" id="pelangganFormModalLabel">
    ...
    <script src="controller/pelangganController.js"></script>
</body>
