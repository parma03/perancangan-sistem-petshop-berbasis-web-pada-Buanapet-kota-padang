<?php
// admin/controller/historiCartController.php
session_start();
    ...
    if ($request == 'get_transaksi_cart') {
        try {
            ...
            $query = "SELECT 
                      ...
                      WHERE tc.status_transaksi_cart = 'completed'
            ...
            if (count($transaksis) > 0) {
                ...
                <div class="alert alert-info text-center" role="alert">
                    <i class="fas fa-info-circle me-2"></i>Belum ada data histori transaksi barang.
                </div>
                <?php
            }
    ...
    if ($request == 'get_transaksi_cart_detail') {
        ...
        try {
            $query = "SELECT 
                      ...
                      JOIN tb_user u ON c.id_user = u.id_user
                      JOIN tb_pelanggan p ON u.id_user = p.id_user
                      WHERE tc.id_transaksi_cart = ? AND tc.status_transaksi_cart = 'completed'";
