...
<body>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="text-primary m-0">
                            <i class="fas fa-users-cog me-2"></i>Data transaksi booking services
                        </h6>
                    </div>
                    ...
                    <div class="transaksi-data-container">
                        <div class="text-center py-3">
                            ...
                            <p class="mt-2">Memuat data transaksi booking services...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="transaksiDetailModalLabel">
                        <i class="fas fa-user-shield me-2"></i>Detail transaksi
                    </h5>
                ...
                <div class="modal-body">
                    <div id="transaksiDetailContent">
                        <div class="text-center py-3">
                            ...
                            <p class="mt-2">Memuat detail transaksi booking services...</p>
                        </div>
                    </div>
                </div>
    ...
    <script src="controller/transaksiServicesController.js"></script>
</body>
